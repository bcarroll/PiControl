...
class PiControlChart():
    ...
    def addData(self, data):
        ...
        if self.fill_empty and self.max_elements > len(self.list):
            ...
            while self.max_elements-1 > len(self.list):
                ...
                if self.labels:
                    ...
                    self.labels.append(time.strftime( self.datetime_format, localtime( int(time()) - previous_label_offset ) ))
        ...
        self.labels.append( time.strftime( self.datetime_format, localtime( int( time() ) ) ) )
