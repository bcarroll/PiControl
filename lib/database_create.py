...
def create_database(database_file='db/PiControl.db'):
    ...
    if os.path.isfile(database_file):
        ...
        print(' enter a new passphrase (8 characters minimum) to be used as the PiControl Secret Key.')
        print("\n")
        print('If you have already created a PiControl Secret Key passphrase on another Raspberry Pi')
        print(' on your network, enter that passphrase.')
        print('######################################################################################')
        print("\n")
